...
export class AuthService {
    ...
    */
    getAuthors(): Observable<Auth[]> {
        return this.http.get<Auth[]>(API_URL + authors, { headers: this.headers }).catch(err => this.handleError(err));
    }
    ...
    */
    getAuthor(authorId): Observable<Auth> {
        return this.http.get<Auth>(API_URL + authors + '/' + authorId, { headers: this.headers }).catch(err => this.handleError(err));
    }
